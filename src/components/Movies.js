...
function Movies() {
  ...
  const getMovieDetails = () => {
    fetch(
      `https://api.themoviedb.org/3/movie/${id}?api_key=7c8e662c141d552a09c780fb61d3f40d`
    )
      .then((resp) => resp.json())
      .then((data) => {
        ...
        <div className="container">
          <div className="sideBar mediaSideBar">
            ...
            <div className="dBoard mediaHome1">
              <Link to="/">
                <img className="home" src={Pix2} alt="" />
              </Link>
              <Link to="/">
                <p>Home</p>
              </Link>
            ...
            <div className="dBoard mediaHome2">
              <Link to="/">
                <img className="movies" src={Pix3} alt="" />
              </Link>
              <Link to="/">
                <p>Movies</p>
              </Link>
            ...
            <div className="dBoard mediaHome3">
              <Link to="/">
                <img className="tvSeries" src={Pix4} alt="" />
              </Link>
              <Link to="/">
                <p>TV Series</p>
              </Link>
            ...
            <div className="dBoard mediaHome4">
              <Link to="/">
                <img className="calendar" src={Pix5} alt="" />
              </Link>
              <Link to="/">
                <p>Upcoming</p>
              </Link>
          ...
          <div className="dashboardBanner" data-testid="movie-poster">
            ...
            >
              <div className="playIcon">
                <Link to="https://www.youtube.com/watch?v=yrwQZtfY91A">
                  <img src={Play} alt="" />
                </Link>
              </div>
            </div>
            ...
            <div className="banner2">
              <div className="frame1">
                <div className="col1">
                  <h1 data-testid="movie-title" className="tittleTxt">
                    {movieDetails.title}
                    <span data-testid="movie-release-date">
                      • {movieDetails.release_date} • PG-13 • 2h 10m
                    </span>
                  </h1>
                ...
                <div className="col3">
                  <p className="director">
                    Director : <Link to="">Joseph Kosinski</Link>
                  </p>
                  <p className="writers">
                    Writers :{" "}
                    <Link to="">Jim Cash, Jack Epps Jr, Peter Craig</Link>
                  </p>
                  <p className="stars">
                    Stars :{" "}
                    <Link to="">
